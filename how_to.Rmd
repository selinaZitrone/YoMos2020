...
Probably you will get a few errors when first setting up your package with git and GitHub. But don't worry, the error messages from the `usethis` package are quite informative so you can fix the issues quickly and get everything running.
...
Create the basic file structure needed to set up your workflow by calling
