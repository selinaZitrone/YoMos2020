...
One thing you definitely need for this step to work is a [PAT (personal acces token)](https://happygitwithr.com/github-pat.html#github-pat) for GitHub added to your .Renviron file. Check if you have one or create one with `usethis::browse_github_token()`.
