...
- If you want to write a new function and generate the corresponding R script in the `/R` directory, you can conveniently call `usethis::use_r("functionName")`{.R}is will create a file `functionName.R` ind the `/R` directory and open it for you. 
