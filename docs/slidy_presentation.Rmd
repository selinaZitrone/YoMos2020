---
title: "Reproducible data analyisis - R packages as research compendia"
...
![This image was created by [Scriberia](http://www.scriberia.co.uk/) for The Turing Way community and is used under a CC-BY licence.](images/ResearchCompendium-ttw.jpg){width=100%}
...
# Hands-on I: Create a research compendium with the R package structure
...
# Hands-on: add version control to the research compendium
...
# Hands-on: Github Actions for `R CMD check`
